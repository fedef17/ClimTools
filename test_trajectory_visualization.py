...
colors = [cmap(0.05), cmap(0.25), cmap(0.45), cmap(0.8)]
...
if dim == 2:
    ...
    for clu in range(numclus):
        cluok = (ind_ERA == clu)
        color = colors[clu]
        ax.scatter(pvec_anom_ERA[cluok, 0], pvec_anom_ERA[cluok, 1], pvec_anom_ERA[cluok, 2], s = 1, color = color)
    ...
    for clu in range(numclus):
        cluok = (ind_EC == clu)
        color = colors[clu]
        ax.scatter(pvec_anom_EC[cluok, 0], pvec_anom_EC[cluok, 1], pvec_anom_EC[cluok, 2], s = 1, color = color)
    ...
    ax.scatter(pvec_clus_ERA[:,0], pvec_clus_ERA[:,1], pvec_clus_ERA[:,2], color = colors, s = 30)
    ax.scatter(pvec_clus_EC[:,0], pvec_clus_EC[:,1], pvec_clus_EC[:,2], color = colors, s = 10)
