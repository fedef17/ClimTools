...
for ens in ensmem:
    ...
    climat_mon, dates_mon, climat_std = ctl.monthly_climatology(var, dates, dates_range = ctl.range_years(1960,1990))
    ...
    climat_monmed, dates_monmed, climat_stdmed = ctl.monthly_climatology(var_med, dates, dates_range = ctl.range_years(1960,1990))
